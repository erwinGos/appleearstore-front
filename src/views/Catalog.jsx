...
const Catalog = () => {
  ...
  const [colorList, setColorList] = useState([]);
    ...
    return (
      ...
      <main className="mx-auto max-w-2xl px-8 sm:px-6 lg:max-w-7xl lg:px-8">

        <div className="pt-12 pb-12 lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
          <aside>
                        ...
                        {section.options.map((option, optionIdx) => (
                          <div key={option.value} className="flex items-center">
                            <input
                              ...
                              defaultValue={option.value}
                              type="checkbox"
                              className={`h-4 w-4 rounded border-gray-300 colorText focus:none`}
                            />
